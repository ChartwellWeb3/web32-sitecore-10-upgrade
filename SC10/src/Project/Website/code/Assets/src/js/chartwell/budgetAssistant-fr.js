...
function calculateCashProceed() {
    ...
    if (cashProceeds < 0) {
      ...
      document.getElementById("cashProceedsError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
    }
    else {
...
function addBenefits() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(gbTemp)) {
            ...
            document.getElementById("benefitsError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>"
            gbTemp = 0;
        }
        else if (gbTemp < 0) {
            document.getElementById("benefitsError").style.display = "block";
            document.getElementById("benefitsError").innerHTML = "<p>Veillez saisir une valeur positive</p>"
            gbTemp = 0;
        }
        else {
            document.getElementById("benefitsError").style.display = "none";
...
function addPension() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("pensionError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            pensionTemp = 0;

            //document.getElementById("errorMsg").style.display = "block";
            document.getElementById("pensionError1").style.display = "block";
            document.getElementById("pensionError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (pensionTemp < 0) {
                document.getElementById("pensionError").style.display = "block";
                document.getElementById("pensionError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                pensionTemp = 0;
                //document.getElementById("errorMsg").style.display = "block";
                document.getElementById("pensionError1").style.display = "block";
                document.getElementById("pensionError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (pensionTemp > 10000000) {
                document.getElementById("pensionError").style.display = "block";
                document.getElementById("pensionError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                pensionTemp = 0;
                //document.getElementById("errorMsg").style.display = "block";
                document.getElementById("pensionError1").style.display = "block";
                document.getElementById("pensionError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function addOas() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("oasError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            oasTemp = 0;
            //document.getElementById("errorMsg").style.display = "block";
            document.getElementById("oasError1").style.display = "block";
            document.getElementById("oasError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            ...
            if (oasTemp < 0) {
                document.getElementById("oasError").style.display = "block";
                document.getElementById("oasError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                oasTemp = 0;
                //document.getElementById("errorMsg").style.display = "block";
                document.getElementById("oasError1").style.display = "block";
                document.getElementById("oasError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";

            }
            else if (oasTemp > 10000000) {
                document.getElementById("oasError").style.display = "block";
                document.getElementById("oasError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                oasTemp = 0;
                //document.getElementById("errorMsg").style.display = "block";
                document.getElementById("oasError1").style.display = "block";
                document.getElementById("oasError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
...
function addGis() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("gisError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            gisTemp = 0;

            document.getElementById("gisError1").style.display = "block";
            document.getElementById("gisError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (gisTemp < 0) {
                document.getElementById("gisError").style.display = "block";
                document.getElementById("gisError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                gisTemp = 0;

                document.getElementById("gisError1").style.display = "block";
                document.getElementById("gisError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (gisTemp > 10000000) {
                document.getElementById("gisError").style.display = "block";
                document.getElementById("gisError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                gisTemp = 0;

                document.getElementById("gisError1").style.display = "block";
                document.getElementById("gisError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function addBenefitsOther() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("benefitsOtherError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            benefitsTemp = 0;

            document.getElementById("benefitsOtherError1").style.display = "block";
            document.getElementById("benefitsOtherError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (benefitsTemp < 0) {
                document.getElementById("benefitsOtherError").style.display = "block";
                document.getElementById("benefitsOtherError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                benefitsTemp = 0;

                document.getElementById("benefitsOtherError1").style.display = "block";
                document.getElementById("benefitsOtherError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (benefitsTemp > 10000000) {
                document.getElementById("benefitsOtherError").style.display = "block";
                document.getElementById("benefitsOtherError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                benefitsTemp = 0;

                document.getElementById("benefitsOtherError1").style.display = "block";
                document.getElementById("benefitsOtherError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function addRetirementSaving() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("retirementError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            retirementTemp = 0;

            document.getElementById("retirementError1").style.display = "block";
            document.getElementById("retirementError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            ...
            if (retirementTemp < 0) {
                document.getElementById("retirementError").style.display = "block";
                document.getElementById("retirementError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                retirementTemp = 0;

                document.getElementById("retirementError1").style.display = "block";
                document.getElementById("retirementError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (retirementTemp > 10000000) {
                document.getElementById("retirementError").style.display = "block";
                document.getElementById("retirementError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                retirementTemp = 0;

                document.getElementById("retirementError1").style.display = "block";
                document.getElementById("retirementError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("retirementError").style.display = "none";
...
function addRRSP() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("rrspError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            RRSPTemp = 0;

            document.getElementById("rrspError1").style.display = "block";
            document.getElementById("rrspError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (RRSPTemp < 0) {
                document.getElementById("rrspError").style.display = "block";
                document.getElementById("rrspError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                RRSPTemp = 0;

                document.getElementById("rrspError1").style.display = "block";
                document.getElementById("rrspError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (RRSPTemp > 10000000) {
                document.getElementById("rrspError").style.display = "block";
                document.getElementById("rrspError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                RRSPTemp = 0;

                document.getElementById("rrspError1").style.display = "block";
                document.getElementById("rrspError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("rrspError").style.display = "none";
...
function addRRIF() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("rrifError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            RRIFTemp = 0;

            document.getElementById("rrifError1").style.display = "block";
            document.getElementById("rrifError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (RRIFTemp < 0) {
                document.getElementById("rrifError").style.display = "block";
                document.getElementById("rrifError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                RRIFTemp = 0;

                document.getElementById("rrifError1").style.display = "block";
                document.getElementById("rrifError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (RRIFTemp > 10000000) {
                document.getElementById("rrifError").style.display = "block";
                document.getElementById("rrifError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                RRIFTemp = 0;

                document.getElementById("rrifError1").style.display = "block";
                document.getElementById("rrifError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("rrifError").style.display = "none";
...
function addLRIF() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("lrifError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            LRIFTemp = 0;

            document.getElementById("lrifError1").style.display = "block";
            document.getElementById("lrifError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (LRIFTemp < 0) {
                document.getElementById("lrifError").style.display = "block";
                document.getElementById("lrifError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                LRIFTemp = 0;

                document.getElementById("lrifError1").style.display = "block";
                document.getElementById("lrifError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (LRIFTemp > 10000000) {
                document.getElementById("lrifError").style.display = "block";
                document.getElementById("lrifError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                LRIFTemp = 0;

                document.getElementById("lrifError1").style.display = "block";
                document.getElementById("lrifError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("lrifError").style.display = "none";
...
function addInvestment() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("investmentError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            investmentTemp = 0;

            document.getElementById("investmentError1").style.display = "block";
            document.getElementById("investmentError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (investmentTemp < 0) {
                document.getElementById("investmentError").style.display = "block";
                document.getElementById("investmentError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                investmentTemp = 0;

                document.getElementById("investmentError1").style.display = "block";
                document.getElementById("investmentError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (investmentTemp > 10000000) {
                document.getElementById("investmentError").style.display = "block";
                document.getElementById("investmentError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                investmentTemp = 0;

                document.getElementById("investmentError1").style.display = "block";
                document.getElementById("investmentError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("investmentError").style.display = "none";
...
function addCompanyPension() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("companyPensionError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            companyPensionTemp = 0;

            document.getElementById("companyPensionError1").style.display = "block";
            document.getElementById("companyPensionError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (companyPensionTemp < 0) {
                document.getElementById("companyPensionError").style.display = "block";
                document.getElementById("companyPensionError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                companyPensionTemp = 0;

                document.getElementById("companyPensionError1").style.display = "block";
                document.getElementById("companyPensionError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (companyPensionTemp > 10000000) {
                document.getElementById("companyPensionError").style.display = "block";
                document.getElementById("companyPensionError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                companyPensionTemp = 0;

                document.getElementById("companyPensionError1").style.display = "block";
                document.getElementById("companyPensionError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("companyPensionError").style.display = "none";
...
function addEmployment() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("employmentError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            employmentTemp = 0;

            document.getElementById("employmentError1").style.display = "block";
            document.getElementById("employmentError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (employmentTemp < 0) {
                document.getElementById("employmentError").style.display = "block";
                document.getElementById("employmentError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                employmentTemp = 0;

                document.getElementById("employmentError1").style.display = "block";
                document.getElementById("employmentError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (employmentTemp > 10000000) {
                document.getElementById("employmentError").style.display = "block";
                document.getElementById("employmentError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                employmentTemp = 0;

                document.getElementById("employmentError1").style.display = "block";
                document.getElementById("employmentError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("employmentError").style.display = "none";
...
function addOther() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("otherIncomeError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            otherTemp = 0;

            document.getElementById("otherIncomeError1").style.display = "block";
            document.getElementById("otherIncomeError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (otherTemp < 0) {
                document.getElementById("otherIncomeError").style.display = "block";
                document.getElementById("otherIncomeError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                otherTemp = 0;

                document.getElementById("otherIncomeError1").style.display = "block";
                document.getElementById("otherIncomeError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (otherTemp > 10000000) {
                document.getElementById("otherIncomeError").style.display = "block";
                document.getElementById("otherIncomeError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                otherTemp = 0;

                document.getElementById("otherIncomeError1").style.display = "block";
                document.getElementById("otherIncomeError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("otherIncomeError").style.display = "none";
...
function addRental() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("rentalError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            rentalTemp = 0;

            document.getElementById("rentalError1").style.display = "block";
            document.getElementById("rentalError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (rentalTemp < 0) {
                document.getElementById("rentalError").style.display = "block";
                document.getElementById("rentalError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                rentalTemp = 0;

                document.getElementById("rentalError1").style.display = "block";
                document.getElementById("rentalError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (rentalTemp > 10000000) {
                document.getElementById("rentalError").style.display = "block";
                document.getElementById("rentalError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                rentalTemp = 0;

                document.getElementById("rentalError1").style.display = "block";
                document.getElementById("rentalError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("rentalError").style.display = "none";
...
function addOtherIncome() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("otherIncome2Error").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            otherIncomeTemp = 0;

            document.getElementById("otherIncome2Error1").style.display = "block";
            document.getElementById("otherIncome2Error1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (otherIncomeTemp < 0) {
                document.getElementById("otherIncome2Error").style.display = "block";
                document.getElementById("otherIncome2Error").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                otherIncomeTemp = 0;

                document.getElementById("otherIncome2Error1").style.display = "block";
                document.getElementById("otherIncome2Error1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (otherIncomeTemp > 10000000) {
                document.getElementById("otherIncome2Error").style.display = "block";
                document.getElementById("otherIncome2Error").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                otherIncomeTemp = 0;

                document.getElementById("otherIncome2Error1").style.display = "block";
                document.getElementById("otherIncome2Error1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("otherIncome2Error").style.display = "none";
...
function updateHomeValue() {
    ...
    if (myTemp == "") {
      ...
      document.getElementById("homeError1").innerHTML = "<p>La valeur maximale est de 25 000 000</p>";
        document.getElementById("homeValue").value = "0";
        document.getElementById("homeError2").style.display = "block";
      document.getElementById("homeError2").innerHTML = "<p>La valeur maximale est de 25 000 000</p>";
        document.getElementById("rateOfReturn").style.display = "none";
        document.getElementById("defaultDisplay").selected = "true";
        document.getElementById("own").style.display = "none";
        rateOfReturn = 0;
        ...
        if (isNaN(myTemp)) {
            document.getElementById("homeError1").style.display = "block";
            document.getElementById("homeError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            homeValue = 0;

            document.getElementById("homeError2").style.display = "block";
            document.getElementById("homeError2").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            document.getElementById("rateOfReturn").style.display = "none";
            document.getElementById("defaultDisplay").selected = "true";
            rateOfReturn = 0;
            document.getElementById("own").style.display = "none";
            ...
            if (homeValue < 25000 || homeValue > 25000000) {
              ...
              document.getElementById("homeError2").innerHTML = "<p>La valeur maximale est de 25 000 000</p>";
                ...
                document.getElementById("homeError1").style.display = "block";
                document.getElementById("homeError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                homeValue = 0;

                document.getElementById("homeError2").style.display = "block";
                document.getElementById("homeError2").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                document.getElementById("rateOfReturn").style.display = "none";
                document.getElementById("defaultDisplay").selected = "true";
                rateOfReturn = 0;
                document.getElementById("own").style.display = "none";
...
function updateMortgage() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("mortgageError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            mortgage = 0;

            document.getElementById("mortgageError1").style.display = "block";
            document.getElementById("mortgageError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (mortgage < 0) {
                document.getElementById("mortgageError").style.display = "block";
                document.getElementById("mortgageError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                mortgage = 0;

                document.getElementById("mortgageError1").style.display = "block";
                document.getElementById("mortgageError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (mortgage > 10000000) {
                document.getElementById("mortgageError").style.display = "block";
                document.getElementById("mortgageError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                mortgage = 0;

                document.getElementById("mortgageError1").style.display = "block";
                document.getElementById("mortgageError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
...
function updateLegal() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("legalError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            legal = 0;

            document.getElementById("legalError1").style.display = "block";
            document.getElementById("legalError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (legal < 0) {
                document.getElementById("legalError").style.display = "block";
                document.getElementById("legalError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                legal = 0;

                document.getElementById("legalError1").style.display = "block";
                document.getElementById("legalError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (legal > 10000000) {
                document.getElementById("legalError").style.display = "block";
                document.getElementById("legalError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                legal = 0;

                document.getElementById("legalError1").style.display = "block";
                document.getElementById("legalError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("legalError").style.display = "none";
...
function updateCommission() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("commissionError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            commission = 0;

            document.getElementById("commissionError1").style.display = "block";
            document.getElementById("commissionError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (commission < 0) {
                document.getElementById("commissionError").style.display = "block";
                document.getElementById("commissionError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                commission = 0;

                document.getElementById("commissionError1").style.display = "block";
                document.getElementById("commissionError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (commission > 10000000) {
                document.getElementById("commissionError").style.display = "block";
                document.getElementById("commissionError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                commission = 0;

                document.getElementById("commissionError1").style.display = "block";
                document.getElementById("commissionError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("commissionError").style.display = "none";
...
function updateMovingCosts() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("movingCostsError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            movingCosts = 0;

            document.getElementById("movingCostsError1").style.display = "block";
            document.getElementById("movingCostsError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (movingCosts < 0) {
                document.getElementById("movingCostsError").style.display = "block";
                document.getElementById("movingCostsError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                movingCosts = 0;

                document.getElementById("movingCostsError1").style.display = "block";
                document.getElementById("movingCostsError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (movingCosts > 10000000) {
                document.getElementById("movingCostsError").style.display = "block";
                document.getElementById("movingCostsError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                movingCosts = 0;

                document.getElementById("movingCostsError1").style.display = "block";
                document.getElementById("movingCostsError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function getOwnRate() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("rateError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            rateOfReturn = 0;

            document.getElementById("rateError1").style.display = "block";
            document.getElementById("rateError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            calculateCashProceed();
            calculateHomeEquity();
            ...
            if (rateOfReturn < 0) {
                document.getElementById("rateError").style.display = "block";
                document.getElementById("rateError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                rateOfReturn = 0;

                document.getElementById("rateError1").style.display = "block";
                document.getElementById("rateError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                calculateCashProceed();
                calculateHomeEquity();
            }
                ...
                document.getElementById("rateError").style.display = "block";
                document.getElementById("rateError").innerHTML = "<p>La valeur maximale est de 30%.</p>";
                rateOfReturn = 0;

                document.getElementById("rateError1").style.display = "block";
                document.getElementById("rateError1").innerHTML = "<p>La valeur maximale est de 30%.</p>";
                calculateCashProceed();
                calculateHomeEquity();
            }
...
function updateMortgageCost() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("mortgageCostError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            mortgageCost = 0;

            document.getElementById("mortgageCostError1").style.display = "block";
            document.getElementById("mortgageCostError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (mortgageCost < 0) {
                document.getElementById("mortgageCostError").style.display = "block";
                document.getElementById("mortgageCostError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                mortgageCost = 0;

                document.getElementById("mortgageCostError1").style.display = "block";
                document.getElementById("mortgageCostError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (mortgageCost > 10000000) {
                document.getElementById("mortgageCostError").style.display = "block";
                document.getElementById("mortgageCostError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                mortgageCost = 0;

                document.getElementById("mortgageCostError1").style.display = "block";
                document.getElementById("mortgageCostError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function updateRent() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("rentError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            rent = 0;

            document.getElementById("rentError1").style.display = "block";
            document.getElementById("rentError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (rent < 0) {
                document.getElementById("rentError").style.display = "block";
                document.getElementById("rentError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                rent = 0;

                document.getElementById("rentError1").style.display = "block";
                document.getElementById("rentError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (rent > 10000000) {
                document.getElementById("rentError").style.display = "block";
                document.getElementById("rentError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                rent = 0;

                document.getElementById("rentError1").style.display = "block";
                document.getElementById("rentError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function updateCondo() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("condoError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            condo = 0;

            document.getElementById("condoError1").style.display = "block";
            document.getElementById("condoError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (condo < 0) {
                document.getElementById("condoError").style.display = "block";
                document.getElementById("condoError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                condo = 0;

                document.getElementById("condoError1").style.display = "block";
                document.getElementById("condoError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (condo > 10000000) {
                document.getElementById("condoError").style.display = "block";
                document.getElementById("condoError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                condo = 0;

                document.getElementById("condoError1").style.display = "block";
                document.getElementById("condoError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function updatePropertyTaxes() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("propertyTaxesError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            propertyTaxes = 0;

            document.getElementById("propertyTaxesError1").style.display = "block";
            document.getElementById("propertyTaxesError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            ...
            if (propertyTaxes < 0) {
                document.getElementById("propertyTaxesError").style.display = "block";
                document.getElementById("propertyTaxesError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                propertyTaxes = 0;

                document.getElementById("propertyTaxesError1").style.display = "block";
                document.getElementById("propertyTaxesError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (propertyTaxes > 10000000) {
                document.getElementById("propertyTaxesError").style.display = "block";
                document.getElementById("propertyTaxesError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                propertyTaxes = 0;

                document.getElementById("propertyTaxesError1").style.display = "block";
                document.getElementById("propertyTaxesError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("propertyTaxesError").style.display = "none";
...
function updateUtilitiesGas() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("gasError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            utilitiesGas = 0;

            document.getElementById("gasError1").style.display = "block";
            document.getElementById("gasError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (utilitiesGas < 0) {
                document.getElementById("gasError").style.display = "block";
                document.getElementById("gasError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                utilitiesGas = 0;

                document.getElementById("gasError1").style.display = "block";
                document.getElementById("gasError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (utilitiesGas > 10000000) {
                document.getElementById("gasError").style.display = "block";
                document.getElementById("gasError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                utilitiesGas = 0;

                document.getElementById("gasError1").style.display = "block";
                document.getElementById("gasError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("gasError").style.display = "none";
...
function updateUtilitiesElectricity() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("electricityError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            utilitiesElectricity = 0;

            document.getElementById("electricityError1").style.display = "block";
            document.getElementById("electricityError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (utilitiesElectricity < 0) {
                document.getElementById("electricityError").style.display = "block";
                document.getElementById("electricityError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                utilitiesElectricity = 0;

                document.getElementById("electricityError1").style.display = "block";
                document.getElementById("electricityError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (utilitiesElectricity > 10000000) {
                document.getElementById("electricityError").style.display = "block";
                document.getElementById("electricityError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                utilitiesElectricity = 0;

                document.getElementById("electricityError1").style.display = "block";
                document.getElementById("electricityError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function updateOtherUtilities() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("otherUtlitiesError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            otherUtilities = 0;

            document.getElementById("otherUtlitiesError1").style.display = "block";
            document.getElementById("otherUtlitiesError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (otherUtilities < 0) {
                ...
                document.getElementById("otherUtlitiesError").style.display = "block";
                document.getElementById("otherUtlitiesError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                otherUtilities = 0;

                document.getElementById("otherUtlitiesError1").style.display = "block";
                document.getElementById("otherUtlitiesError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (otherUtilities > 10000000) {
                document.getElementById("otherUtlitiesError").style.display = "block";
                document.getElementById("otherUtlitiesError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                otherUtilities = 0;

                document.getElementById("otherUtlitiesError1").style.display = "block";
                document.getElementById("otherUtlitiesError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("otherUtlitiesError").style.display = "none";
...
function updatePremium() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("premiumError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            premium = 0;

            document.getElementById("premiumError1").style.display = "block";
            document.getElementById("premiumError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (premium < 0) {
                document.getElementById("premiumError").style.display = "block";
                document.getElementById("premiumError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                premium = 0;

                document.getElementById("premiumError1").style.display = "block";
                document.getElementById("premiumError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (premium > 10000000) {
                document.getElementById("premiumError").style.display = "block";
                document.getElementById("premiumError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                premium = 0;

                document.getElementById("premiumError1").style.display = "block";
                document.getElementById("premiumError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function updateLawnCare() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("lawnError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            lawnCare = 0;

            document.getElementById("lawnError1").style.display = "block";
            document.getElementById("lawnError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (lawnCare < 0) {
                document.getElementById("lawnError").style.display = "block";
                document.getElementById("lawnError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                lawnCare = 0;

                document.getElementById("lawnError1").style.display = "block";
                document.getElementById("lawnError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (lawnCare > 10000000) {
                document.getElementById("lawnError").style.display = "block";
                document.getElementById("lawnError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                lawnCare = 0;

                document.getElementById("lawnError1").style.display = "block";
                document.getElementById("lawnError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function updateLandscaping() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("landscapingError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            landscaping = 0;

            document.getElementById("landscapingError1").style.display = "block";
            document.getElementById("landscapingError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (landscaping < 0) {
                document.getElementById("landscapingError").style.display = "block";
                document.getElementById("landscapingError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                landscaping = 0;

                document.getElementById("landscapingError1").style.display = "block";
                document.getElementById("landscapingError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (landscaping > 10000000) {
                document.getElementById("landscapingError").style.display = "block";
                document.getElementById("landscapingError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                landscaping = 0;

                document.getElementById("landscapingError1").style.display = "block";
                document.getElementById("landscapingError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function updateSnowRemoval() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("snowError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            snowRemoval = 0;

            document.getElementById("snowError1").style.display = "block";
            document.getElementById("snowError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (snowRemoval < 0) {
                document.getElementById("snowError").style.display = "block";
                document.getElementById("snowError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                snowRemoval = 0;

                document.getElementById("snowError1").style.display = "block";
                document.getElementById("snowError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (snowRemoval > 10000000) {
                document.getElementById("snowError").style.display = "block";
                document.getElementById("snowError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                snowRemoval = 0;

                document.getElementById("snowError1").style.display = "block";
                document.getElementById("snowError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function updateSecurity() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("securityError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            security = 0;

            document.getElementById("securityError1").style.display = "block";
            document.getElementById("securityError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            ...
            if (security < 0) {
                document.getElementById("securityError").style.display = "block";
                document.getElementById("securityError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                security = 0;

                document.getElementById("securityError1").style.display = "block";
                document.getElementById("securityError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (security > 10000000) {
                document.getElementById("securityError").style.display = "block";
                document.getElementById("securityError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                security = 0;

                document.getElementById("securityError1").style.display = "block";
                document.getElementById("securityError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
...
function updateWindowClean() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("windowError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            windowClean = 0;

            document.getElementById("windowError1").style.display = "block";
            document.getElementById("windowError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (windowClean < 0) {
                document.getElementById("windowError").style.display = "block";
                document.getElementById("windowError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                windowClean = 0;

                document.getElementById("windowError1").style.display = "block";
                document.getElementById("windowError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (windowClean > 10000000) {
                document.getElementById("windowError").style.display = "block";
                document.getElementById("windowError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                windowClean = 0;

                document.getElementById("windowError1").style.display = "block";
                document.getElementById("windowError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("windowError").style.display = "none";
...
function updateGarbageCollection() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("garbageCollectionError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            garbageCollection = 0;

            document.getElementById("garbageCollectionError1").style.display = "block";
            document.getElementById("garbageCollectionError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (garbageCollection < 0) {
                document.getElementById("garbageCollectionError").style.display = "block";
                document.getElementById("garbageCollectionError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                garbageCollection = 0;

                document.getElementById("garbageCollectionError1").style.display = "block";
                document.getElementById("garbageCollectionError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (garbageCollection > 10000000) {
                document.getElementById("garbageCollectionError").style.display = "block";
                document.getElementById("garbageCollectionError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                garbageCollection = 0;

                document.getElementById("garbageCollectionError1").style.display = "block";
                document.getElementById("garbageCollectionError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("garbageCollectionError").style.display = "none";
...
function updateRoof() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("roofError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            roof = 0;

            document.getElementById("roofError1").style.display = "block";
            document.getElementById("roofError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (roof < 0) {
                document.getElementById("roofError").style.display = "block";
                document.getElementById("roofError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                roof = 0;

                document.getElementById("roofError1").style.display = "block";
                document.getElementById("roofError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (roof > 10000000) {
                document.getElementById("roofError").style.display = "block";
                document.getElementById("roofError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                roof = 0;

                document.getElementById("roofError1").style.display = "block";
                document.getElementById("roofError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("roofError").style.display = "none";
...
function updateFurnace() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("furnaceError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            furnace = 0;

            document.getElementById("furnaceError1").style.display = "block";
            document.getElementById("furnaceError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (furnace < 0) {
                document.getElementById("furnaceError").style.display = "block";
                document.getElementById("furnaceError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                furnace = 0;

                document.getElementById("furnaceError1").style.display = "block";
                document.getElementById("furnaceError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (furnace > 10000000) {
                document.getElementById("furnaceError").style.display = "block";
                document.getElementById("furnaceError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                furnace = 0;

                document.getElementById("furnaceError1").style.display = "block";
                document.getElementById("furnaceError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("furnaceError").style.display = "none";
...
function updateAirConditioning() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("acError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            airConditioning = 0;

            document.getElementById("acError1").style.display = "block";
            document.getElementById("acError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (airConditioning < 0) {
                document.getElementById("acError").style.display = "block";
                document.getElementById("acError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                airConditioning = 0;

                document.getElementById("acError1").style.display = "block";
                document.getElementById("acError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (airConditioning > 10000000) {
                document.getElementById("acError").style.display = "block";
                document.getElementById("acError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                airConditioning = 0;

                document.getElementById("acError1").style.display = "block";
                document.getElementById("acError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("acError").style.display = "none";
...
function updateAppliances() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("appliancesError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            appliances = 0;

            document.getElementById("appliancesError1").style.display = "block";
            document.getElementById("appliancesError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (appliances < 0) {
                document.getElementById("appliancesError").style.display = "block";
                document.getElementById("appliancesError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                appliances = 0;

                document.getElementById("appliancesError1").style.display = "block";
                document.getElementById("appliancesError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (appliances > 10000000) {
                document.getElementById("appliancesError").style.display = "block";
                document.getElementById("appliancesError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                appliances = 0;

                document.getElementById("appliancesError1").style.display = "block";
                document.getElementById("appliancesError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("appliancesError").style.display = "none";
...
function updateEmergencyRepairs() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("emergencyError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            emergencyRepairs = 0;

            document.getElementById("emergencyError1").style.display = "block";
            document.getElementById("emergencyError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (emergencyRepairs < 0) {
                document.getElementById("emergencyError").style.display = "block";
                document.getElementById("emergencyError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                emergencyRepairs = 0;

                document.getElementById("emergencyError1").style.display = "block";
                document.getElementById("emergencyError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (emergencyRepairs > 10000000) {
                document.getElementById("emergencyError").style.display = "block";
                document.getElementById("emergencyError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                emergencyRepairs = 0;

                document.getElementById("emergencyError1").style.display = "block";
                document.getElementById("emergencyError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("emergencyError").style.display = "none";
...
function updateOtherMaintenance() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("otherMaintenanceError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            otherMaintenance = 0;

            document.getElementById("otherMaintenanceError1").style.display = "block";
            document.getElementById("otherMaintenanceError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (otherMaintenance < 0) {
                document.getElementById("otherMaintenanceError").style.display = "block";
                document.getElementById("otherMaintenanceError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                otherMaintenance = 0;

                document.getElementById("otherMaintenanceError1").style.display = "block";
                document.getElementById("otherMaintenanceError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (otherMaintenance > 10000000) {
                document.getElementById("otherMaintenanceError").style.display = "block";
                document.getElementById("otherMaintenanceError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                otherMaintenance = 0;

                document.getElementById("otherMaintenanceError1").style.display = "block";
                document.getElementById("otherMaintenanceError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("otherMaintenanceError").style.display = "none";
...
function updateOtherCosts() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("otherCostsError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            otherCosts = 0;

            document.getElementById("otherCostsError1").style.display = "block";
            document.getElementById("otherCostsError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (otherCosts < 0) {
                document.getElementById("otherCostsError").style.display = "block";
                document.getElementById("otherCostsError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                otherCosts = 0;

                document.getElementById("otherCostsError1").style.display = "block";
                document.getElementById("otherCostsError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (otherCosts > 10000000) {
                document.getElementById("otherCostsError").style.display = "block";
                document.getElementById("otherCostsError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                otherCosts = 0;

                document.getElementById("otherCostsError1").style.display = "block";
                document.getElementById("otherCostsError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("otherCostsError").style.display = "none";
...
function updateFoodExpense() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("foodExpensesError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            foodExpense = 0;

            document.getElementById("foodExpensesError1").style.display = "block";
            document.getElementById("foodExpensesError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (foodExpense < 0) {
                document.getElementById("foodExpensesError").style.display = "block";
                document.getElementById("foodExpensesError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                foodExpense = 0;

                document.getElementById("foodExpensesError1").style.display = "block";
                document.getElementById("foodExpensesError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (foodExpense > 10000000) {
                document.getElementById("foodExpensesError").style.display = "block";
                document.getElementById("foodExpensesError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                foodExpense = 0;

                document.getElementById("foodExpensesError1").style.display = "block";
                document.getElementById("foodExpensesError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("foodExpensesError").style.display = "none";
...
function updateEntertainment() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("entertainmentError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            entertainment = 0;

            document.getElementById("entertainmentError1").style.display = "block";
            document.getElementById("entertainmentError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (entertainment < 0) {
                document.getElementById("entertainmentError").style.display = "block";
                document.getElementById("entertainmentError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                entertainment = 0;

                document.getElementById("entertainmentError1").style.display = "block";
                document.getElementById("entertainmentError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }

            else if (entertainment > 10000000) {
                document.getElementById("entertainmentError").style.display = "block";
                document.getElementById("entertainmentError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                entertainment = 0;

                document.getElementById("entertainmentError1").style.display = "block";
                document.getElementById("entertainmentError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("entertainmentError").style.display = "none";
...
function updateLoan() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("LeaseError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            loan = 0;

            document.getElementById("LeaseError1").style.display = "block";
            document.getElementById("LeaseError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (loan < 0) {
                document.getElementById("LeaseError").style.display = "block";
                document.getElementById("LeaseError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                loan = 0;

                document.getElementById("LeaseError1").style.display = "block";
                document.getElementById("LeaseError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (loan > 10000000) {
                document.getElementById("LeaseError").style.display = "block";
                document.getElementById("LeaseError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                loan = 0;

                document.getElementById("LeaseError1").style.display = "block";
                document.getElementById("LeaseError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("LeaseError").style.display = "none";
...
function updateGas() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("carGasError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            gas = 0;

            document.getElementById("carGasError1").style.display = "block";
            document.getElementById("carGasError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (gas < 0) {
                document.getElementById("carGasError").style.display = "block";
                document.getElementById("carGasError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                gas = 0;

                document.getElementById("carGasError1").style.display = "block";
                document.getElementById("carGasError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (gas > 10000000) {
                document.getElementById("carGasError").style.display = "block";
                document.getElementById("carGasError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                gas = 0;

                document.getElementById("carGasError1").style.display = "block";
                document.getElementById("carGasError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("carGasError").style.display = "none";
...
function updateCarInsurance() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("carInsuranceError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            carInsurance = 0;

            document.getElementById("carInsuranceError1").style.display = "block";
            document.getElementById("carInsuranceError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (carInsurance < 0) {
                document.getElementById("carInsuranceError").style.display = "block";
                document.getElementById("carInsuranceError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                carInsurance = 0;

                document.getElementById("carInsuranceError1").style.display = "block";
                document.getElementById("carInsuranceError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (carInsurance > 10000000) {
                document.getElementById("carInsuranceError").style.display = "block";
                document.getElementById("carInsuranceError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                carInsurance = 0;

                document.getElementById("carInsuranceError1").style.display = "block";
                document.getElementById("carInsuranceError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("carInsuranceError").style.display = "none";
...
function updateCarMaintenance() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("carMaintenanceError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            carMaintenance = 0;

            document.getElementById("carMaintenanceError1").style.display = "block";
            document.getElementById("carMaintenanceError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (carMaintenance < 0) {
                document.getElementById("carMaintenanceError").style.display = "block";
                document.getElementById("carMaintenanceError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                carMaintenance = 0;

                document.getElementById("carMaintenanceError1").style.display = "block";
                document.getElementById("carMaintenanceError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (carMaintenance > 10000000) {
                document.getElementById("carMaintenanceError").style.display = "block";
                document.getElementById("carMaintenanceError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                carMaintenance = 0;

                document.getElementById("carMaintenanceError1").style.display = "block";
                document.getElementById("carMaintenanceError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("carMaintenanceError").style.display = "none";
...
function updateLicense() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("licenseError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            license = 0;

            document.getElementById("licenseError1").style.display = "block";
            document.getElementById("licenseError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (license < 0) {
                document.getElementById("licenseError").style.display = "block";
                document.getElementById("licenseError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                license = 0;

                document.getElementById("licenseError1").style.display = "block";
                document.getElementById("licenseError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (license > 10000000) {
                document.getElementById("licenseError").style.display = "block";
                document.getElementById("licenseError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                license = 0;

                document.getElementById("licenseError1").style.display = "block";
                document.getElementById("licenseError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("licenseError").style.display = "none";
...
function updateParking() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("parkingError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            parking = 0;

            document.getElementById("parkingError1").style.display = "block";
            document.getElementById("parkingError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (parking < 0) {
                document.getElementById("parkingError").style.display = "block";
                document.getElementById("parkingError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                parking = 0;

                document.getElementById("parkingError1").style.display = "block";
                document.getElementById("parkingError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (parking > 10000000) {
                document.getElementById("parkingError").style.display = "block";
                document.getElementById("parkingError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                parking = 0;

                document.getElementById("parkingError1").style.display = "block";
                document.getElementById("parkingError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("parkingError").style.display = "none";
...
function updateCarWash() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("carWashError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            carWash = 0;
            document.getElementById("carWashError1").style.display = "block";
            document.getElementById("carWashError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (carWash < 0) {
                document.getElementById("carWashError").style.display = "block";
                document.getElementById("carWashError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                carWash = 0;
                document.getElementById("carWashError1").style.display = "block";
                document.getElementById("carWashError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (carWash > 10000000) {
                document.getElementById("carWashError").style.display = "block";
                document.getElementById("carWashError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                carWash = 0;
                document.getElementById("carWashError1").style.display = "block";
                document.getElementById("carWashError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("carWashError").style.display = "none";
...
function updateRepairs() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("repairsError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            repairs = 0;

            document.getElementById("repairsError1").style.display = "block";
            document.getElementById("repairsError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
            ...
            if (repairs < 0) {
                document.getElementById("repairsError").style.display = "block";
                document.getElementById("repairsError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                repairs = 0;

                document.getElementById("repairsError1").style.display = "block";
                document.getElementById("repairsError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (repairs > 10000000) {
                document.getElementById("repairsError").style.display = "block";
                document.getElementById("repairsError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                repairs = 0;

                document.getElementById("repairsError1").style.display = "block";
                document.getElementById("repairsError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("repairsError").style.display = "none";
...
function updateOtherTransportation() {
    ...
    if (myTemp == "") {
        ...
        if (isNaN(myTemp)) {
            ...
            document.getElementById("transportationError").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
            otherTransportation = 0;

            document.getElementById("transportationError1").style.display = "block";
            document.getElementById("transportationError1").innerHTML = "<p>Veuillez saisir une valeur numérique</p>";
        }
        else {
            ...
            if (otherTransportation < 0) {
                document.getElementById("transportationError").style.display = "block";
                document.getElementById("transportationError").innerHTML = "<p>Veillez saisir une valeur positive</p>";
                otherTransportation = 0;

                document.getElementById("transportationError1").style.display = "block";
                document.getElementById("transportationError1").innerHTML = "<p>Veillez saisir une valeur positive</p>";
            }
            else if (otherTransportation > 10000000) {
                document.getElementById("transportationError").style.display = "block";
                document.getElementById("transportationError").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
                otherTransportation = 0;

                document.getElementById("transportationError1").style.display = "block";
                document.getElementById("transportationError1").innerHTML = "<p>La valeur maximale est de 10 000 000</p>";
            }
            else {
                document.getElementById("transportationError").style.display = "none";
